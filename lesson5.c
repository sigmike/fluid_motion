...
void DrawGLScene()
{
  ...
  glVertex3f(-0.1f,0.0f, 0.1f);		// left of triangle (front)
  glVertex3f(0.1f,0.0f, 0.1f);		        // right of traingle (front)	

  // right face of pyramid
  glColor3f(1.0f,0.0f,0.0f);			// Red
  glVertex3f( 0.0f, 1.0f, 0.0f);		// Top Of Triangle (Right)
  glColor3f(0.0f,1.0f,0.0f);			// Green
  glVertex3f( 0.1f,0.0f, 0.1f);		// Left Of Triangle (Right)
  glColor3f(0.0f,0.0f,1.0f);			// Blue
  glVertex3f( 0.1f,0.0f, -0.1f);		// Right Of Triangle (Right)

  // back face of pyramid
  glColor3f(1.0f,0.0f,0.0f);			// Red
  glVertex3f( 0.0f, 1.0f, 0.0f);		// Top Of Triangle (Back)
  glColor3f(0.0f,0.0f,1.0f);			// Blue
  glVertex3f( 0.1f,0.0f, -0.1f);		// Left Of Triangle (Back)
  glVertex3f(-0.1f,0.0f, -0.1f);		// Right Of Triangle (Back)

  // left face of pyramid.
  glColor3f(1.0f,0.0f,0.0f);			// Red
  glVertex3f( 0.0f, 1.0f, 0.0f);		// Top Of Triangle (Left)
  glColor3f(0.0f,0.0f,1.0f);			// Blue
  glVertex3f(-0.1f,0.0f,-0.1f);		// Left Of Triangle (Left)
  glColor3f(0.0f,1.0f,0.0f);			// Green
  glVertex3f(-0.1f,0.0f, 0.1f);		// Right Of Triangle (Left)
